# CHEZZ: TOTAL WAR 戦国 — beat Stockfish

Our own chess engine, **Musashi** (Rust), climbs a ladder of strength-limited Stockfish opponents, and every battle
...
```
backend/engine   Rust UCI engine "musashi": PVS alpha-beta, iterative deepening, TT, null move,
...
backend/runner   python-chess drives Musashi vs Stockfish 19 (UCI_LimitStrength + UCI_Elo),
